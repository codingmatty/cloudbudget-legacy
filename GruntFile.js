...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    clean: {
      build: {
        src: [BUILD_DIR + '*', '!' + BUILD_DIR + 'index.html']
      },
      scripts: {
        src: [BUILD_DIR_JS + '*.js']
      }
...
//    },
    ...
    concat: {
      dist: {
        ...
        src: [SRC_FILES_JS, '!' + SRC_DIR_JS + 'lib/**'],
        dest: BUILD_FILE_JS
      }
    },
...
//      }
  ...
  var registerBuildTask = function(mode) {
    grunt.registerTask('build:' + mode, 
      ...
      ['clean:build', 'copy', 'bower', 'stylesheets:' + mode, 'scripts:' + mode/*, 'jade'*/]
    );
  };
